...
function toggleLoading(isLoading) {
  ...
  if (isLoading)
  {
    document.getElementById("searchbnt").innerHTML = "<i class='fas fa-hourglass-half' id='searchicon'></i>Loading...";
    document.getElementById("searchbnt").style.color = "gray";
    document.getElementById("searchbnt").disable = true;
  }
  else
  {
    document.getElementById("searchbnt").innerHTML = "<i class='fas fa-search' id='searchicon'></i>Search";
    document.getElementById("searchbnt").style.color = "black";
    document.getElementById("searchbnt").disable = false;
  }
